...
class SpeakerIdentity:
    ...
    def display_name(self) -> str:
        if self.speaker_name and self.speaker_model:
            return f"{self.speaker_name} ({self.speaker_model})"
        return self.speaker_name or self.speaker_model or self.ip or "<unknown>"
